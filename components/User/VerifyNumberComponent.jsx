  ...
  return (
    <section className="">
      <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        ...
        >
          <img
            className="mx-auto w-20 md:hidden"
            src="/images/logo.svg"
            alt="logo"
          />
        </a>
            ...
            <form className="space-y-4 md:space-y-6" action="#">
              ...
              <div className="flex items-center justify-center">
                <button
                  onClick={() => sendOtp()}
                  type="button"
                  className="text-white w-full md:w-4/12 mt-5  bg-blue-500 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm  py-3 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
                >
                  ارسال کد
                </button>
                {sendOtpSuccess && (
