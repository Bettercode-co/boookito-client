    ...
    <div className="border border-gray-200 p-10 rounded-lg max-w-md w-full space-y-8">
      <div>
        ...
        <p className="text-center text-sm text-gray-600 mt-5">
          <a href="#" className="font-medium text-blue-600 hover:text-indigo-500">کد ارسال شد </a>
        </p>
      </div>
      <div className="mt-8 space-y-6">
        <form onSubmit={handleVerify}>
          ...
          <div>
            <button type="submit" className={code.length == 5 ? "group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-blue-500 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
