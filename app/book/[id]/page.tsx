...
export default function BookPage() {
    ...
    if (loading) {
        return (
            <main className="p-6 md:p-8 lg:p-12 max-w-6xl mx-auto">
       ...
       <>
           ...
           <main className="p-6 md:p-8 lg:p-12 max-w-6xl mx-auto">
            <div className="mb-8 mt-20">
                <button
                    onClick={() => router.back()}
                    className="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700   rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
                >
                    <svg
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8 md:gap-12">
                ...
                <div className="md:col-span-2 lg:col-span-3">
                    ...
                    <p className="text-md leading-8 -tracking-[1 em] text-gray-600 mb-4 ">
                    ...
                    <div>
                            ...
                            <Chip radius="sm" size='lg' className='bg-[#3e3e45] text-white'  variant="shadow">شما میتوانید با کد کتاب {toFarsiNumber(book.id)} این کتاب را حضوری از کتابخانه دانشگاه {book.library.libraryName} تحویل بگیرید</Chip>
                    ...
                    <div className="space-y-4 mb-8  py-6">
                        {book.translatorName && book.translatorName.length > 0 && book.translatorName[0] !== '' && (
                            <div>
                                ...
                                <p className="text-gray-500">{(book.translatorName)}</p>
                            </div>
                        )}
                        <div>
                            <span className="font-medium text-gray-800 block text-sm mb-1">
                                دسته‌بندی:
                            </span>
                            <p className="text-gray-600">{book.subCategory.name}</p>
                        </div>
                        <div>
                            <span className="font-medium text-gray-700 block text-sm mb-1">
                                انتشارات:
                            </span>
                            <p className="text-gray-500">{book.publisherName}</p>
                        </div>
