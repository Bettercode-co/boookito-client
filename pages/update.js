        ...
        <div className="lg:gap-4 lg:flex">
          <div className="flex flex-col items-center justify-center md:py-24 lg:py-32">
            ...
            <p className="mb-8 text-center text-gray-500 md:text-lg">
              ممکن است خطایی در سرور رخ داده باشد یا در حال به روزرسانی
              باشیم.بعد از ساعاتی دوباره سرویس برقرار میشود
            </p>

            <Link href="/">
              <a className="px-6 py-2 text-sm font-semibold rounded-lg w-40 text-center text-blue-500 bg-green-100">
                بازگشت به خانه
              </a>
            </Link>
          </div>
