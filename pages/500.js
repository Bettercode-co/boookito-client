...
export default function Custom500() {
    return   <div className="flex items-center justify-center w-screen md:w-full h-screen">
      ...
      <div className="lg:gap-4 lg:flex">
        ...
        >
         ...
         <a
            ...
            className="px-6 py-2 text-sm font-semibold rounded-lg w-40 text-center text-blue-500 bg-blue-100"
            >بازگشت به خانه</a
          >
         </Link>
        </div>
